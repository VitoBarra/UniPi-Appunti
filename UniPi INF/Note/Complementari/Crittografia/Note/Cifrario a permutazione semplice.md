...
la cifratura avviene dividendo il messaggio in $n=\frac{|m|}{h}$ blocchi se la _lunghezza_ del messaggio $m$ non é [[Divisibilità dei numeri|divisibile]] per $h$ si aggiungono lettere a caso per raggiungere il prossimo multiplo di $h$, questa aggiunta è chiamato _padding_ 
