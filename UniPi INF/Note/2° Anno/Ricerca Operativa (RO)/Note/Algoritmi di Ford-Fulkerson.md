...
### *Teorema*
Se le capacita degli archi di un [[Grafo|grafo]] sono intere, allora l [[Algoritmi|algoritmo]] di Ford-Fulkerson trova un flusso di valore massimo dopo un numero finito di iterazioni.
...
![[UniPi INF/Note/2° Anno/Ricerca Operativa (RO)/Media/Untitled 1 13.png]]

![[UniPi INF/Note/2° Anno/Ricerca Operativa (RO)/Media/Untitled 2 8.png]]

![[UniPi INF/Note/2° Anno/Ricerca Operativa (RO)/Media/Untitled 3 6.png]]

![[UniPi INF/Note/2° Anno/Ricerca Operativa (RO)/Media/Untitled 4 4.png]]