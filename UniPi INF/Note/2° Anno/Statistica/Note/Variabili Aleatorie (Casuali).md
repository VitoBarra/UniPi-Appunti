...
---
in [[Statistica (STAT)|statistica]] le _variabili aleatorie_ sono uno strumento matematico che ci permettono di dare un formalismo matematico piu agile rispetto al solo _[[Probabilita|Spazzio di probabilita]]_ $(\Omega,\mathcal{F},\mathcal{P})$ che è associato ad un esperimento che vogliamo studiare.
...
_sia_ $(\Omega,\mathcal{F},\mathcal{P})$ uno _[[Probabilita|spazio di probabiltia]]_ 
...
#### Proposizione
la funzione di insiemi $\mathcal{P}_{X}$ è una [[Probabilita|Probabilità]] su $\mathbb{R}$ detta _legge di pobabilità_ di $X$ 
