...
- $X$ con [[Probabilita sui numeri Reali#Densità di probabilità (Definizione)|denstia]]  $N(0,1)$ ovvero [[Variabili Aleatorie Notevoli|gaussiana]] 
...
_alllora_ questa per $n$ grande la successione $(T_{n})_{n\geq 1}$ [[Convergenza in distribuzione|converge in distribuzione]] ad $N(0,1)$ ovvero ad una [[Variabili Aleatorie Notevoli|gaussiana standard]].
