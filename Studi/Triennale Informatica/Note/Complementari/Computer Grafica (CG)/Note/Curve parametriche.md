...
# Curve parametriche
---
Una __curva parametrica__ é una [[Funzioni|funzione]] tra lo spazio dei parametri $A \subseteq  \mathbb{R}$ allo spazio 3D $B \subseteq \mathbb{R}^3$$$C(t)=(X(t),Y(t),Z(t))$$Solitamene $A=[0,1]$ in questo modo $C(0)$ rappresenta l inizio della curva e $C(1)$ rappresenta la fine.
