...
$$Questo tipo di distribuzione viene definito **_naive_** poiché si basa sull’assunzione che le variabili effetto siano [[Indipendenza condizionata|condizionalemente indipendenti]], ipotesi che nella pratica è spesso false. Nonostante questo nella pratica funziona bene

per usare il modello si usa la regola di [[Inferenza con Full Joint distribution|inrenza per la full joint distribution ]] per inferire la probabilità della **causa** a partire da un insieme di effetti osservati $E = e$, ovvero:$$
