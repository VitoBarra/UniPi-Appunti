...
La determinazione dell'indipendenza tra sotto problemi si basa sull'individuazione delle [[Graph Theory|componenti connesse]] del [[Graph Theory|grafo]] dei vincoli. Ogni **componente definisce un sotto problema** $CSP_i$ e l'unione delle soluzioni parziali $\bigcup_i S_i$ rappresenta una soluzione complessiva $\bigcup_i CSP_i$. 
