...
---
L un [[Agenti Razionali|agente]] capaci di prendere delle decisioni in [[Modelli Probabilistici  - Agire in domini incerti|ambienti incerti]] usa l'**inferenza probabilistica** che consiste nel calcolo delle [[Probabilita condizionata|probabilità posteriori]] per proposizioni di interesse, date alcune evidenze osservate $e$. Una strategia generale prevede l'utilizzo della **[[Full Joint Distribution (FJD)|full joint distribution]]** come **base di conoscenza** $KB$, da cui possono essere derivate tutte le risposte possibili. In pratica si vuole fare una **query** al $KB$ del tipo:
**sia**
