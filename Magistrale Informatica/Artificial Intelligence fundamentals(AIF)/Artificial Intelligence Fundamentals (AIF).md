	...
	1. [[Logica]]
		...
		3. [[Sistemi di inferenza logica]]
			...
			2. [[Inferenza logica per dimostrazione di teoremi]]
				1. [[Algoritmo di inferenza logica tramite risoluzione]]
				2. [[Algoritmo Forwarding and Backward chaining per Dimostrazione di teoremi]]
		4. [[Algoritmo DPLL per SAT]]
		5. [[Metodi locali per SAT]]
	2. [[Agenti Logici con FOL]]
		1. [[Semantica Database per FOL]]
		2. [[Sistema di inferenza per FOL]]
	3. [[Agenti logici - Sistemi a regole]]
		1. [[Risoluzione SLD]]
