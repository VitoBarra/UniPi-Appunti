...
$$
poiche il termine $p(\mathcal{D})$ non dipende da $\theta$.

Il MAP e quindi una stima puntuale della posterior: invece di integrare su tutte le ipotesi come in [[Bayesian learning]], ne seleziona una sola, cioe la piu plausibile dopo aver osservato i dati.
