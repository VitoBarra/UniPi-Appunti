...
Nel contesto dei [[Formati di file biologici]], il formato PDB si distingue dai formati di sequenza e annotazione, poiché non rappresenta una sequenza lineare di simboli biologici, ma una configurazione spaziale tridimensionale. Questa differenza concettuale rende il formato PDB complementare ai formati come [[Formato FASTA]] e [[GenBank - Formato per annotazione genomica|GenBank]], che descrivono la struttura primaria e l’annotazione funzionale, ma non la conformazione spaziale. Il formato PDB costituisce quindi un elemento centrale per l’integrazione tra bioinformatica strutturale, chimica computazionale e modellistica molecolare.
