...
Le coordinate atomiche sono espresse in unità di lunghezza standard e consentono di calcolare distanze, angoli e relazioni spaziali tra gli atomi. Queste informazioni sono fondamentali per la descrizione della [[Geometria molecolare]] e per la valutazione dell’[[Energia Molecolare]] nei modelli computazionali. Il formato PDB include inoltre campi dedicati alla descrizione di legami, fattori di occupazione e parametri di incertezza, che riflettono la natura sperimentale dei dati strutturali.
