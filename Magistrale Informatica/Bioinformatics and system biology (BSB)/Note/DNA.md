...
# DNA
---
il **DNA** è una [[Molecole|molecola]] che immagazzina le **informazioni genetiche** necessarie per la **sintesi proteica** e la **regolazione dell’espressione genica**. A livello informazionale, l'insieme completo del materiale genetico è il [[Genoma|genoma]], mentre alcune sue regioni funzionali sono i [[Gene|geni]].
...
La distinzione concettuale tra **mutazioni** e **polimorfismi** si fonda sulla frequenza nella popolazione: 
- una **mutazione** una frequenza $<1\%$ ed è associata con potenziali effetti patologici
- un **polimorfismo** ha frequenza $>1\%$ ed è generalmente neutro o tollerato
	- un esempio di polimorfismo sono i _**Single Nucleotide Polymorphism**_ (SNPs), variazioni di singoli [[Nucleotidi|nucleotidi]]
