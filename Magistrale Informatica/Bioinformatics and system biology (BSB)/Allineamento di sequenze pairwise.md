...
---
L’**allineamento di sequenze pairwise** è un tipo di [[Allineamento di sequenze]] in cui il confronto è limitato a **due sequenze**. Esso rappresenta il caso elementare del problema di allineamento e costituisce la base concettuale per estensioni più complesse, come l’[[Allineamento multiplo|allineamento multiplo]]. Il pairwise alignment introduce una **corrispondenza esplicita** tra le posizioni delle due sequenze.
