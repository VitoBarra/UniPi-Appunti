...
![[IMG - Marching Squares griglia di campioni.png]]
...
- blue se $f(x,y)>\alpha$
![[IMG - Marching Squares vertici attivi e inattivi.png]]
e poi
...
![[IMG - Marching Squares interpolazione lineare dell intersezione.png]]
utilizzando il set di $2^4=16$ [[Combinatoria|permutazioni]] e salvandoli una volta in una __look-up table__  
![[IMG - Marching Squares lookup table dei casi.png]]
si ottiene ad esempio la superfice.
![[IMG - Marching Squares isosuperficie risultante.png]]
...
![[IMG [[Interpolazione Bilineare|interpolazione bilineare]]biguità si valuta il valore del campo al centro usando l'[[interpolazione bilineare|interpolazione bilineare]] della cella e si ha che a seconda del valore nel centro
