...
_sia_
- $X_{1},\dots X_{n}$ un [[Campione Statistico|campione statistico]] la cui legge di [[Probabilita sui numeri Reali|probabilita]] ha [[Variabili aleatoria - Momenti o Valore atteso|momento secondo]] finito.
- $\alpha \in (0,1)$
...
_sia_
- $X_{1},\dots X_{n}$ un _[[Campione Statistico|campione statistico]]_ la cui legge di [[Probabilita sui numeri Reali|probabilita]] ha [[Variabili aleatoria - Momenti o Valore atteso|momento secondo]] finito.
- $\alpha \in (0,1)$
