...
[[Variabili Aleatorie Notevoli - Bernulli|la variabile di Bernoulli]] assume il valore 1 con [[Definizione di Probabilita|probabilità]] $p$ ed il valore $0$ con [[Definizione di Probabilita|probabilita]] $(1−p)$, ed è dunque immediato constatare i [[Variabili aleatoria - Momenti o Valore atteso|momenti]] _primo e secondo_ siano $$E[X]=p \ \ \ \ \ \ \ E[X^{2}] =p$$
