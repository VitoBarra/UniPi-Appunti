...
_Se_ si riesce a calcolare la _[[Variabili aleatorie - Funzione di ripartizione (CDF)|funzione di ripartizione]]_ $F_{Y}$ di $Y$ con $$F_{Y}= \mathcal{P}\{ Y \leq y \} =\mathcal{P}\{ h(X) \leq y  \} $$
