...
# Campione Statistico
---
_sia_ $X_{1},\dots, X_{n},\dots$ una [[Famiglia di variabili aleatorie Indipendenti e identicamente distribuite (IDD)|famiglia i.d.d.]]  definite su uno stesso [[Probabilita sui numeri Reali#Densità di probabilità (Definizione)|spazio di probabilita]] e tutte hanno la stessa [[Variabili aleatorie - Funzione di ripartizione (CDF)|funzone di ripartizione]] $F=F_{X}$ 
