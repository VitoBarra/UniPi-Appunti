...
_allora_ la _stima_ ottenuto dal metodo di [[Stima Parametrica - Maximum Liklehood|massima verosomiglianza]] è    
...
m  \\ x_{i}
\end{pmatrix}$$usando il _[[Stima Parametrica - Maximum Liklehood#Criterio per trovare il massimo|criterio per trovare il parametro massimo]]_ si ha che  $$
\begin{array}{}
