...
_allora_ la _stima_ ottenuto dal metodo di [[Maximum Liklehood learning|massima verosomiglianza]] è    
...
m  \\ x_{i}
\end{pmatrix}$$usando il _[[Maximum Liklehood learning#Criterio per trovare il massimo|criterio per trovare il parametro massimo]]_ si ha che  $$
\begin{array}{}
