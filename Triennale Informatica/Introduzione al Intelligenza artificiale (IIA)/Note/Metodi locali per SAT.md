...
---
è una classe di algoritmi di tipo [[Ricerca locale|locale]] per la risoluzione di [[Problemi della Sodisfacibilita (SAT)|SAT]] nel contesto del utilizzo di [[Agenti Logici - Calcolo proposizionale|Agenti con calcolo proposizionale]]. dove:
