...
---
il __Blur gaussiano__ è un applicazione del __[[Filtering|filtering]]__ e serve a dare un effetto di blur alle immagini in modo da ammorbidirle. questo si fa usando la [[Variabili Aleatorie Notevoli - Gaussiana|distribuzioni gaussiane]] $$f(x)=\cfrac{1}{\sigma \sqrt{ 2\pi }}e^{-\cfrac{(x-\mu)^2}{\sigma^2}}$$
![[IMG - Filtering - Gaussian Blur 1.png]]
e infatti i pesi del kernel sono assegnati con due [[Variabili Aleatorie Notevoli - Gaussiana|distribuzioni gaussiane]] con la formula
...
![[IMG - Filtering - Gaussian Blur 2.png]]
