...
R_M\\G_M\\B_M
\end{bmatrix}$$
![[IMG - Illuminazione - Modello Phong 1.png]]
...
_allora_ il __componente diffusivo__ è definito come  $$L_{\text{diffuse}} = L_{\text{incident}}\cos \theta$$e quindi per la relazione [[Prodotto scalare euclideo (Dot product)|coseno-dotpuduct]] si ha $$L_{\text{diffuse}} = L_{\text{incident}}(\boldsymbol{L}\cdot \boldsymbol{N})$$![[IMG - Illuminazione - Modello Phong 2.png]]
![[IMG - Illuminazione - Modello Phong 3.png]]
...
_allora_ il __componente diffusivo__ è definito come  $$L_{\text{specular}} = L_{\text{incident}}(\cos \alpha)^{n_s}$$e quindi per la relazione [[Prodotto scalare euclideo (Dot product)|coseno-dotpuduct]] si ha $$\cos \alpha = \boldsymbol{R} \cdot \boldsymbol{V}$$![[IMG - Illuminazione - Modello Phong 4.png]]
![[IMG - Illuminazione - Modello Phong 5.png]]

L esponente $n_n$ controlla la __glossines__  (o __shinies__) della superficie, ovvero quanto è concentrato il riflesso. 
![[IMG - Illuminazione - Modello Phong 6.png]]
e fa variare il cose come 
![[IMG - Illuminazione - Modello Phong 7.png]]
...
![[IMG - Illuminazione - Modello Phong 8.png]]
...
![[IMG - Illuminazione - Modello Phong 9.png]]
...
![[IMG - Illuminazione - Modello Phong 10.png]]
...
![[IMG - Illuminazione - Modello Phong 11.png]]

Alcuni esempi di materiali
![[IMG - Illuminazione - Modello Phong 12.png]]