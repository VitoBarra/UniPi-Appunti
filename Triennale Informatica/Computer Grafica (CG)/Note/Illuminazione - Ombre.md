...
_allora_ vale che $$\varepsilon=\text{clamp}(\alpha \tan (\arccos(n\cdot L)),min\_\varepsilon,max\_\varepsilon)$$![[IMG - Illuminazione - Ombre 10.png]]
...
![[IMG - Illuminazione - Ombre 11.png]]
