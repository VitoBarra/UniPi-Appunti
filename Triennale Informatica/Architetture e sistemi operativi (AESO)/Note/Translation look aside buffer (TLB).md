...
![[IMG - Translation look aside buffer (TLB) 1.jpeg]]
...
![[IMG - Translation look aside buffer (TLB) 2.jpeg]]
...
- **Process context switch**:
    ...
    ![[IMG - Translation look aside buffer (TLB) 3.jpeg]]
...
- **TLB shootdown (stesso sopra ma multyproccessore)**:
    ...
    ![[IMG - Translation look aside buffer (TLB) 4.jpeg]]