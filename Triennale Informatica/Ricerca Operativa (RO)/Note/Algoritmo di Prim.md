...
3. Trova un arco $(u,v)$ di costo minimo tra gli archi del [[Taglio su grafo|taglio]] $(S,N \backslash S)$ inserisci $(u,v)$ in  $T$
4. inserisci in $S$ l’ estremo di $(u,v)$ che non appartiene ad $S$ e torna al passo $2$

![[UniPi-Appunti/Triennale Informatica/Ricerca Operativa (RO)/Media/IMG - algoritmo di prim.png]]
