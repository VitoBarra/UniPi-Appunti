...
ad ogni flusso $x$ associamo il [[Struttura dati - Grafi|grafo]] residuo $G(x) = (N,A')$ in cui l insieme degli archi $A'$ è cosi definito:
...
![[UniPi-Appunti/Triennale Informatica/Ricerca Operativa (RO)/Media/Untitled 1 5.png]]
