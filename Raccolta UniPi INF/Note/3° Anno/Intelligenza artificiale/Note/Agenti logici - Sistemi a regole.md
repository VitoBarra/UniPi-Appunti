...
possiamo quindi risscrivere le regole 
...
Se la [[Base di conoscenza (KB)| base di conoscemnza]] è formata solo da clausole HOrn Definite i [[Sistemi di deduzione (o di Inferenza)|meccanismi di inferenza]] sono molto più semplici e non si rinuncia _completezza_.
...
- $A$ è vero se sono veri $B_1,B_2,\dots,B_n$  in accordo al significato logico dell implicazione 
