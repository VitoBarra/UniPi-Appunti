...
# Alberi di decisione per AI
---
modello di  [[Machine Learning (ML)|machine lerning]] per imparare degli [[Albero di decisione|Albero di decisione]] per il [[Concept Learning|Concept Learning]]
...
- la ricerca mantiene una singola ipotesi corrente ([[Ricerca in salita o HIll Climbing per AI|hill-Climbing]])
...
1. si preferiscono alberi corti rispetto a quelli lunghi
	...
	2. _non basta_  questo bias  è lo stesso di una semplice [[Ricerca in ampiezza BF-AI|breath first ]] che esplora tutto l albero e sceglie il percorso piu corto
